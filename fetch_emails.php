...
:root {
  ...
  --green:#90AB8B; --amber:#c9a84c; --red:#d95f5f;
...
.logo-icon{width:44px;height:44px;background:linear-gradient(135deg,var(--violet),var(--cyan));border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.2rem;flex-shrink:0;box-shadow:0 0 22px var(--violet-glow);}
...
<div class="card">
  <div class="header-row">
    ...
    <div>
      <div class="header-title">Mail<span>X</span> Sync</div>
  ...
  <div class="btn-group">
    <a href="index.php"        class="btn btn-primary">→ View Inbox</a>
    <a href="fetch_emails.php" class="btn btn-ghost">↻ Fetch Again</a>
  </div>
</div>
</body>
</html>
